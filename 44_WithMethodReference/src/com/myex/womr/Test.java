...
while using method reference, referrer and referring both methods should have same arguments, but method name, return type,
access modifiers can be different and both method can be static or non static in any combination is fine.
